        ...
        <>
          <View style={styles.textContainerWithIcon}>
            ...
            <Text style={styles.text}>
              {' ICE is a digital currency that you can mine'}
            </Text>
          </View>
          <Text style={styles.text}>
      ...
      text: (
        <>
          <View style={styles.textContainerWithIcon}>
            <LogoIconSvg />
            <Text style={styles.text}>
              {' ICE is inherently more energy efficient than BTC'}
            </Text>
          </View>
          <Text style={styles.text}>
      ...
      text: (
        <>
          ...
          <View style={styles.textContainerWithIcon}>
            ...
            <LogoIconSvg />
            <Text style={styles.text}>{' ICE will be'}</Text>
          </View>
          <Text style={styles.text}>
      ...
      text: (
        <>
          <View style={styles.textContainerWithIcon}>
            <LogoIconSvg />
            <Text style={styles.text}>
              {'ICE mining sessions only last for 24 hours.'}
            </Text>
          </View>
          <Text style={styles.text}>
